...
from homeassistant.components.pinergy.const import DOMAIN
...
from tests.common import MockConfigEntry, async_capture_events, mock_restore_cache
...
async def _setup_entry(hass: HomeAssistant) -> MockConfigEntry:
    ...
    with patch(
        "homeassistant.components.pinergy.coordinator.PinergyDataUpdateCoordinator.async_config_entry_first_refresh",
