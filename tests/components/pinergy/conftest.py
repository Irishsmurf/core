...
def mock_pinergy_client() -> Generator[MagicMock]:
    ...
    with (
        patch(
            "homeassistant.components.pinergy.config_flow.PinergyClient", autospec=True
        ) as mock_client_cls,
        patch("homeassistant.components.pinergy.PinergyClient", new=mock_client_cls),
    ):
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "homeassistant.components.pinergy.async_setup_entry", return_value=True
    ) as mock:
        yield mock
